...
public interface IOcrService
{
    ...
    Task<OcrExtractionResult> ExtractInvoiceDataAsync(DocumentUrl fileUrl, CancellationToken cancellationToken = default);
    
    // Para procesar facturas grandes (se hará de forma asincrona)
    Task<OcrOperationId> StartAnalysisAsync(DocumentUrl fileUrl, CancellationToken cancellationToken = default);
